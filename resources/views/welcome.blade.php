        ...
        <section class="services" id="services">
            ...
            <div class="services__description center-column none" id="td2">
                ...
                <p class="services__description-text">
                    Разработка динамических сайтов с нуля. Доработка и исправление ошибок. Настройка, управление и
            ...
            <div class="services__description center-column none" id="td3">
                ...
                <p class="services__description-text">
                    Разработка уникального дизайна: визуал и юзабилити (удобство пользования). Опыт создания проектов
                    по дизайну с нуля. Прозрачное сотрудничество и ценообразование.
                </p>
                <a href="{{route('ui_ux_design')}}">
                    <button class="services__description-button">Узнать больше</button>
                </a>
            </div>
            ...
            <div class="services__description center-column none" id="td4">
                ...
                <p class="services__description-text">
                    ...
                    Интеграция приложений с существующими сайтами. Широкий опыт в различных нишах: услуги, e-commerce,
                    онлайн-образование и другие.
                ...
                <div class="work-tab">
                    ...
                    <div class="how-we-work-tabs_block above">
                        ...
                        <div class="work-block-description">
                            <p>Для начала сотрудничества необходимо заказать обратный звонок или отправить ТЗ на
                                e-mail.</p>
                            <p>Для оперативного получения консультации набирайте самостоятельно по указанным номерам</p>
                            <p>При заказе звонка отвечаем в течение 1 часа. При большой загруженности время может
                                незначительно меняться.</p>
                ...
                <div class="work-tab none">
                    ...
                    <div class="how-we-work-tabs_block above">
                        ...
                        <div class="work-block-description">
                            ...
                            <p>Во время него уточняются детали заказа: особенности дизайна, функциональные пожелания и
                                т.д.</p>
                            <p>Менеджер берет паузу для оценки заказа. Если работа типичная или небольшая, то стоимость
                                называется сразу. </p>
                ...
                <div class="work-tab none">
                    ...
                    <div class="how-we-work-tabs_block above">
                        ...
                        <div class="work-block-description">
                            ...
                            <p>На следующей встрече уже будет разработчик. Для сдачи проекта необходимо 3–10
                                онлайн/офлайн встреч.</p>
                ...
                <div class="work-tab none">
                    ...
                    <div class="how-we-work-tabs_block above">
                        <img class="work-image" src="{{asset('/images/how-we-work/how-we-work-1.jpg')}}"
                             alt="how we work">
                        <div class="work-block-description">
                            <p>Разработка включает в себя не только программирование, но и загрузку контента (нашей
                                командой и клиентом).</p>
                            <p>Во время работы держим постоянную связь и демонстрируем промежуточные итоги.</p>
                            <p>После приемки даем 1-2 недели на проверку сайта. В случае отсутствия недостатков
                                происходит окончательный расчет.</p>
