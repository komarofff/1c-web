...
@section('title', 'Контакты .  ООО ПО Системс групп')
...
<main class="main">
    <section class="sertificate " id="sertificate">
        ...
        <div class="contact__grid_1column">
            <p class="contact-form-title"> Заполните форму, расположенную ниже,
                и мы ответим Вам в ближайшее время</p>
            <form class="contact_form" id="contact_form">
                <input class="contact-form-text" type="text" name="name" id="name" placeholder="Ваше имя" required>
                <p><input class="contact-form-text"  type="text" name="phone" id="phone" placeholder="Контактный телефон" >
                <input class="contact-form-text"  type="email" name="email" id="email" placeholder="E-mail" required>
                </p>
                <select  class="contact-form-text" name="question" id="question">
                    <option value="Хочу заказать сайт">Хочу заказать сайт</option>
                    <option value="Хочу заказать сайт2">Хочу заказать сайт2</option>
                    <option value="Хочу заказать сайт3">Хочу заказать сайт3</option>
                    <option value="Хочу заказать сайт4">Хочу заказать сайт4</option>
                    <option value="Хочу заказать сайт5">Хочу заказать сайт5</option>
                </select>
                <input  class="contact-form-text" type="text" name="message" id="message" placeholder="Ваше сообщение" required>

                <button class="services__description-button">Отправить</button>
            </form>
        </div>
    </section>
