...
/*!************************************************!*\
  !*** ./resources/scripts/technology-slider.js ***!
  \************************************************/
// top slider start
setTimeout(firstClone, 10);
var speed = 6; // slider speed in seconds
...
function firstClone() {
  ...
  document.getElementById("technologies-slider").style.transform = "translateX(-".concat(width_of_element, "px)");
...
function sliderTechnology() {
  ...
  document.getElementById("technologies-slider").style.transform = "translateX(-".concat(transition_width, "px)");
