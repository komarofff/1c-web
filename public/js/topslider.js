...
/*!****************************************!*\
  ...
  \****************************************/
// top slider start
var speed = 5; // slider speed in seconds
...
function firstClone() {
  document.getElementById("technologies-slider").style.cssText = "transition: ".concat(speed, "s linear;transform: translateX(-").concat(width_of_element, "px) ");
